const PowerballResult = require("../../../models/pakistan/PakistanPowerballResult");
...
const addReferralBettingBonus = async (
  ...
  try {
    ...
    console.log(
      "PAKISTAN POWERBALL REFERRAL BONUS"
    );
    ...
    console.error(
      "Pakistan Referral Betting Bonus Error:",
      error
    );
  ...
  async (req, res) => {
    try {
      ...
      return res.status(201).json({
        ...
        message:
          "Pakistan Powerball result declared successfully. Winners and referral bonuses have been credited.",
      ...
      console.error(
        "Create Pakistan Powerball Result Error:",
        error
      );
...
exports.deletePowerballResult =
  async (req, res) => {
    try {
      ...
      console.error(
        "Delete Pakistan Powerball Result Error:",
        error
      );
