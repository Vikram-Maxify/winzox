...
const GameCount = require("../../../models/uae/UAEGameCount");
const mongoose = require("mongoose");

/**
 * Get all game entries with filters
 * GET /api/admin/uae/game-entries
 */
 ...
 * GET /api/admin/uae/game-entries/:id
 */
 ...
 * GET /api/admin/uae/game-entries/user/:userId
 */
 ...
 * GET /api/admin/uae/game-entries/status/:status
 */
 ...
 * GET /api/admin/uae/game-entries/search
 */
 ...
 * GET /api/admin/uae/game-entries/dashboard
 */
 ...
 * GET /api/admin/uae/game-entries/statistics
 */
 ...
 * PUT /api/admin/uae/game-entries/:id/status
 */
...
/**
 * Delete game entry
 * DELETE /api/admin/uae/game-entries/:id
 */
 ...
 * PUT /api/admin/uae/game-entries/bulk/status
 */
 ...
 * GET /api/admin/uae/game-entries/summary
 */
 ...
 * GET /api/admin/uae/game-entries/:poolId/player/:userId
 */
