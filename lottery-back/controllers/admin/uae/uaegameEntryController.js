// controllers/admin/uae/uaegameEntryController.js

const GamePool = require("../../../models/GameEntry");
const User = require("../../../models/authmodel");
const TicketType = require("../../../models/TicketType");
const GameCount = require("../../../models/UAEGameCount");
 ...
 * GET /api/admin/game-entries/user/:userId
 */
 ...
 * GET /api/admin/game-entries/status/:status
 */
 ...
 * GET /api/admin/game-entries/search
 */
 ...
 * GET /api/admin/game-entries/dashboard
 */
 ...
 * GET /api/admin/game-entries/statistics
 */
 ...
 * PUT /api/admin/game-entries/:id/status
 */
...
/**
 * Delete game entry
 * DELETE /api/admin/game-entries/:id
 */
 ...
 * PUT /api/admin/game-entries/bulk/status
 */
 ...
 * GET /api/admin/game-entries/summary
 */
 ...
 * GET /api/admin/game-entries/:poolId/player/:userId
 */
