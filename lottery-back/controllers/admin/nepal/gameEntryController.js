...
const GameCount = require("../../../models/nepal/NepalGameCount");
const mongoose = require("mongoose");

/**
 * Get all game entries with filters
 * GET /api/admin/nepal/game-entries
 */
 ...
 * GET /api/admin/nepal/game-entries/:id
 */
 ...
 * GET /api/admin/nepal/game-entries/user/:userId
 */
 ...
 * GET /api/admin/nepal/game-entries/status/:status
 */
 ...
 * GET /api/admin/nepal/game-entries/search
 */
 ...
 * GET /api/admin/nepal/game-entries/dashboard
 */
 ...
 * GET /api/admin/nepal/game-entries/statistics
 */
 ...
 * PUT /api/admin/nepal/game-entries/:id/status
 */
...
/**
 * Delete game entry
 * DELETE /api/admin/nepal/game-entries/:id
 */
 ...
 * PUT /api/admin/nepal/game-entries/bulk/status
 */
 ...
 * GET /api/admin/nepal/game-entries/summary
 */
 ...
 * GET /api/admin/nepal/game-entries/:poolId/player/:userId
 */
