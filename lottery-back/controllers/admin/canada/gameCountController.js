const CanadaGameCount = require("../../../models/canada/CanadaGameCount");
...
const createGameCount = async (req, res) => {
  try {
    ...
    console.error("Create Canada Game Count Error:", err);
...
const getGameCounts = async (req, res) => {
  try {
    ...
    console.error("Get Canada Game Counts Error:", err);
...
const getGameCount = async (req, res) => {
  try {
    ...
    console.error("Get Canada Game Count Error:", err);
...
const updateGameCount = async (req, res) => {
  try {
    ...
    // Check duplicate when unique fields are changed
    if (
      ...
      const existing = await CanadaGameCount.findOne({
        ticketType:
    ...
    console.error("Update Canada Game Count Error:", err);
...
const deleteGameCount = async (req, res) => {
  try {
    ...
    console.error("Delete Canada Game Count Error:", err);
