const PowerballResult = require("../../../models/australia/AustraliaPowerballResult");
  ...
  try {
    if (
      ...
      return {
        success: false,
        bonus: 0,
        message: "Invalid winner or prize amount",
      };
    }
    ...
    try {
      ...
      if (gamePool) {
        ...
        return res.json({
          ...
          message:
            "Result deleted successfully. Game pool has been reset and balances including referral bonuses have been reversed.",
