...
import { a as createID, I as InlineScheduledTask, n as noopLogger, l as logger } from './_shared.js';
import 'events';
import 'node:crypto';
...
async function startDaemon(message) {
    ...
    const options = { ...(message.options || {}), logger: noopLogger };
