...
export const getGameCounts = createAsyncThunk(
  "indiaGameCount/getAll",
  async (_, { rejectWithValue }) => {
    try {
      const { data } = await api.get("/admin/india/game-count");
      return data.data;
    } catch (err) {
...
export const getGameCount = createAsyncThunk(
  "indiaGameCount/getOne",
  async (id, { rejectWithValue }) => {
    try {
      const { data } = await api.get(`/admin/india/game-count/${id}`);
      return data.data;
    } catch (err) {
      return rejectWithValue(err.response?.data?.message || err.message);
    }
...
export const createGameCount = createAsyncThunk(
  "indiaGameCount/create",
  async (payload, { rejectWithValue }) => {
    try {
      const { data } = await api.post("/admin/india/game-count", payload);
      return data.data;
    } catch (err) {
      return rejectWithValue(err.response?.data?.message || err.message);
    }
...
export const updateGameCount = createAsyncThunk(
  "indiaGameCount/update",
  async ({ id, formData }, { rejectWithValue }) => {
    try {
      const { data } = await api.put(`/admin/india/game-count/${id}`, formData);
      return data.data;
    } catch (err) {
      return rejectWithValue(err.response?.data?.message || err.message);
    }
...
export const deleteGameCount = createAsyncThunk(
  "indiaGameCount/delete",
  async (id, { rejectWithValue }) => {
    try {
      await api.delete(`/admin/india/game-count/${id}`);
      return id;
    } catch (err) {
      return rejectWithValue(err.response?.data?.message || err.message);
    }
