...
export const createPowerballResult = createAsyncThunk(
  "canadaPowerballResult/create",
  async (data, { rejectWithValue }) => {
    try {
      const res = await api.post("/admin/canada/powerball-results/create", data);
      return res.data;
    } catch (err) {
...
export const getAllPowerballResults = createAsyncThunk(
  "canadaPowerballResult/getAll",
  async (_, { rejectWithValue }) => {
    try {
      const res = await api.get("/admin/canada/powerball-results");
      return res.data;
    } catch (err) {
      return rejectWithValue(
        err.response?.data?.message || "Something went wrong."
...
export const getPowerballResultById = createAsyncThunk(
  "canadaPowerballResult/getById",
  async (id, { rejectWithValue }) => {
    try {
      const res = await api.get(`/admin/canada/powerball-results/${id}`);
...
export const deletePowerballResult = createAsyncThunk(
  "canadaPowerballResult/delete",
  async (id, { rejectWithValue }) => {
    try {
      await api.delete(`/admin/canada/powerball-results/${id}`);
      return id;
    } catch (err) {
      return rejectWithValue(
        err.response?.data?.message || "Something went wrong."
...
export const getAllPendingGames = createAsyncThunk(
  "canadaPowerballResult/getAllPendingGames",
  async (_, { rejectWithValue }) => {
    try {
      const res = await api.get(
        "/admin/canada/powerball-results/pending-games/all"
      );
      return res.data;
    } catch (err) {
      return rejectWithValue(
...
export const getPendingGameByPlayerId = createAsyncThunk(
  "canadaPowerballResult/getPendingGame",
  async (playerId, { rejectWithValue }) => {
    try {
      const res = await api.get(
        `/admin/canada/powerball-results/pending-game/${playerId}`
      );
      return res.data;
    } catch (err) {
      return rejectWithValue(
...
export const getGamePoolDetails = createAsyncThunk(
  "canadaPowerballResult/getGamePoolDetails",
  async (poolId, { rejectWithValue }) => {
    try {
      const res = await api.get(
        `/admin/canada/powerball-results/game-pool/${poolId}`
      );
      return res.data;
    } catch (err) {
      return rejectWithValue(
...
// Slice
// ==========================================
const canadaPowerballResultSlice = createSlice({
  name: "canadaPowerballResult",
...
export const {
  ...
  clearSelectedGame,
  clearSelectedPool,
} = canadaPowerballResultSlice.actions;

export default canadaPowerballResultSlice.reducer;
