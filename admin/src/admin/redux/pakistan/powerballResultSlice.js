...
export const createPowerballResult = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      const res = await api.post("/admin/pakistan/powerball-results/create", data);
      return res.data;
    } catch (err) {
...
export const getAllPowerballResults = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await api.get("/admin/pakistan/powerball-results");
      return res.data;
    } catch (err) {
      return rejectWithValue(
        err.response?.data?.message || "Something went wrong."
...
export const getPowerballResultById = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const res = await api.get(`/admin/pakistan/powerball-results/${id}`);
...
export const deletePowerballResult = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      await api.delete(`/admin/pakistan/powerball-results/${id}`);
      return id;
    } catch (err) {
      return rejectWithValue(
        err.response?.data?.message || "Something went wrong."
