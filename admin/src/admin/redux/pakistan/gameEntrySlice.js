...
export const fetchGameEntries = createAsyncThunk(
  "pakistanGameEntry/fetchAll",
  async ({ page = 1, limit = 10, filters = {} }, { rejectWithValue }) => {
    try {
      const queryParams = new URLSearchParams({ page, limit, ...filters }).toString();
      const response = await api.get(`/admin/pakistan/game-entries?${queryParams}`);
...
export const fetchGameEntryById = createAsyncThunk(
  "pakistanGameEntry/fetchById",
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.get(`/admin/pakistan/game-entries/${id}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchGameEntriesByStatus = createAsyncThunk(
  "pakistanGameEntry/fetchByStatus",
  async ({ status, page = 1, limit = 10 }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/pakistan/game-entries/status/${status}?page=${page}&limit=${limit}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const searchGameEntriesByUser = createAsyncThunk(
  "pakistanGameEntry/searchByUser",
  async ({ query, page = 1, limit = 10, status = "" }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/pakistan/game-entries/search?query=${query}&page=${page}&limit=${limit}&status=${status}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const fetchDashboardEntries = createAsyncThunk(
  "pakistanGameEntry/fetchDashboard",
  async ({ limit = 10, status = "" }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/pakistan/game-entries/dashboard?limit=${limit}&status=${status}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const fetchGameEntryStatistics = createAsyncThunk(
  "pakistanGameEntry/fetchStatistics",
  async ({ startDate = "", endDate = "" }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/pakistan/game-entries/statistics?startDate=${startDate}&endDate=${endDate}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const fetchGameEntrySummary = createAsyncThunk(
  "pakistanGameEntry/fetchSummary",
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get("/admin/pakistan/game-entries/summary");
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const updateGameEntryStatus = createAsyncThunk(
  "pakistanGameEntry/updateStatus",
  async ({ id, status }, { rejectWithValue }) => {
    try {
      const response = await api.put(`/admin/pakistan/game-entries/${id}/status`, { status });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const deleteGameEntry = createAsyncThunk(
  "pakistanGameEntry/delete",
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.delete(`/admin/pakistan/game-entries/${id}`);
...
export const bulkUpdateGameEntryStatus = createAsyncThunk(
  "pakistanGameEntry/bulkUpdateStatus",
  async ({ ids, status }, { rejectWithValue }) => {
    try {
      const response = await api.put("/admin/pakistan/game-entries/bulk/status", { ids, status });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchGameEntriesByUser = createAsyncThunk(
  "pakistanGameEntry/fetchByUser",
  async ({ userId, page = 1, limit = 10, status = "" }, { rejectWithValue }) => {
    try {
      const params = new URLSearchParams({ page, limit });
      if (status) params.append("status", status);
      const response = await api.get(`/admin/pakistan/game-entries/user/${userId}?${params}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchPlayerGameDetails = createAsyncThunk(
  "pakistanGameEntry/fetchPlayerDetails",
  async ({ poolId, userId }, { rejectWithValue }) => {
    try {
      const response = await api.get(`/admin/pakistan/game-entries/${poolId}/player/${userId}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const selectAllEntries = (state) => state.pakistanGameEntry.entries;
export const selectSelectedEntry = (state) => state.pakistanGameEntry.selectedEntry;
export const selectLoading = (state) => state.pakistanGameEntry.loading;
export const selectError = (state) => state.pakistanGameEntry.error;
export const selectPagination = (state) => state.pakistanGameEntry.pagination;
export const selectStats = (state) => state.pakistanGameEntry.stats;
export const selectFilters = (state) => state.pakistanGameEntry.filters;
export const selectSummary = (state) => state.pakistanGameEntry.summary;
export const selectStatistics = (state) => state.pakistanGameEntry.statistics;
