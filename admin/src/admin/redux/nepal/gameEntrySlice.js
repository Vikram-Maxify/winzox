...
export const fetchGameEntries = createAsyncThunk(
  "nepalGameEntry/fetchAll",
  async ({ page = 1, limit = 10, filters = {} }, { rejectWithValue }) => {
    try {
      const queryParams = new URLSearchParams({ page, limit, ...filters }).toString();
      const response = await api.get(`/admin/nepal/game-entries?${queryParams}`);
...
export const fetchGameEntryById = createAsyncThunk(
  "nepalGameEntry/fetchById",
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.get(`/admin/nepal/game-entries/${id}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchGameEntriesByStatus = createAsyncThunk(
  "nepalGameEntry/fetchByStatus",
  async ({ status, page = 1, limit = 10 }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/nepal/game-entries/status/${status}?page=${page}&limit=${limit}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const searchGameEntriesByUser = createAsyncThunk(
  "nepalGameEntry/searchByUser",
  async ({ query, page = 1, limit = 10, status = "" }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/nepal/game-entries/search?query=${query}&page=${page}&limit=${limit}&status=${status}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const fetchDashboardEntries = createAsyncThunk(
  "nepalGameEntry/fetchDashboard",
  async ({ limit = 10, status = "" }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/nepal/game-entries/dashboard?limit=${limit}&status=${status}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const fetchGameEntryStatistics = createAsyncThunk(
  "nepalGameEntry/fetchStatistics",
  async ({ startDate = "", endDate = "" }, { rejectWithValue }) => {
    try {
      const response = await api.get(
        `/admin/nepal/game-entries/statistics?startDate=${startDate}&endDate=${endDate}`
      );
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
...
export const fetchGameEntrySummary = createAsyncThunk(
  "nepalGameEntry/fetchSummary",
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get("/admin/nepal/game-entries/summary");
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const updateGameEntryStatus = createAsyncThunk(
  "nepalGameEntry/updateStatus",
  async ({ id, status }, { rejectWithValue }) => {
    try {
      const response = await api.put(`/admin/nepal/game-entries/${id}/status`, { status });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const deleteGameEntry = createAsyncThunk(
  "nepalGameEntry/delete",
  async (id, { rejectWithValue }) => {
    try {
      const response = await api.delete(`/admin/nepal/game-entries/${id}`);
...
export const bulkUpdateGameEntryStatus = createAsyncThunk(
  "nepalGameEntry/bulkUpdateStatus",
  async ({ ids, status }, { rejectWithValue }) => {
    try {
      const response = await api.put("/admin/nepal/game-entries/bulk/status", { ids, status });
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchGameEntriesByUser = createAsyncThunk(
  "nepalGameEntry/fetchByUser",
  async ({ userId, page = 1, limit = 10, status = "" }, { rejectWithValue }) => {
    try {
      const params = new URLSearchParams({ page, limit });
      if (status) params.append("status", status);
      const response = await api.get(`/admin/nepal/game-entries/user/${userId}?${params}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const fetchPlayerGameDetails = createAsyncThunk(
  "nepalGameEntry/fetchPlayerDetails",
  async ({ poolId, userId }, { rejectWithValue }) => {
    try {
      const response = await api.get(`/admin/nepal/game-entries/${poolId}/player/${userId}`);
      return response.data;
    } catch (error) {
      return rejectWithValue(error.response?.data || error.message);
    }
...
export const selectAllEntries = (state) => state.nepalGameEntry.entries;
export const selectSelectedEntry = (state) => state.nepalGameEntry.selectedEntry;
export const selectLoading = (state) => state.nepalGameEntry.loading;
export const selectError = (state) => state.nepalGameEntry.error;
export const selectPagination = (state) => state.nepalGameEntry.pagination;
export const selectStats = (state) => state.nepalGameEntry.stats;
export const selectFilters = (state) => state.nepalGameEntry.filters;
export const selectSummary = (state) => state.nepalGameEntry.summary;
export const selectStatistics = (state) => state.nepalGameEntry.statistics;
