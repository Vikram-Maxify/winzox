...
// BASE URL
// ======================================================
const BASE_URL = "/admin/australia/powerball/divisions";

// ======================================================
// GET ALL DIVISIONS
// ======================================================
export const getAllDivisions = createAsyncThunk(
  "AustraliaPowerballDivision/getAll",
...
export const getActiveDivisions = createAsyncThunk(
  "AustraliaPowerballDivision/getActive",
  async (_, { rejectWithValue }) => {
    try {
...
export const getDivisionById = createAsyncThunk(
  "AustraliaPowerballDivision/getById",
...
export const createDivision = createAsyncThunk(
  "AustraliaPowerballDivision/create",
...
export const updateDivision = createAsyncThunk(
  "AustraliaPowerballDivision/update",
...
export const deleteDivision = createAsyncThunk(
  "AustraliaPowerballDivision/delete",
  async (id, { rejectWithValue }) => {
    try {
...
export const toggleDivisionStatus = createAsyncThunk(
  "AustraliaPowerballDivision/toggle",
  async (id, { rejectWithValue }) => {
    try {
...
const powerballDivisionSlice = createSlice({
  name: "australiaPowerballDivision",
  ...
  extraReducers: (builder) => {
    ...
    builder
      ...
      .addCase(getActiveDivisions.rejected, (state, action) => {
        state.loading = false;
        state.error =
          action.payload || "Failed to fetch active divisions.";
      })
