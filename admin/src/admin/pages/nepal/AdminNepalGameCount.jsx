...
import {
    ...
    createGameCount,
    updateGameCount,
} from "../../redux/nepal/gameCountSlice";
import { getTicketTypes } from "../../redux/ticketTypeSlice";
import { motion, AnimatePresence } from "framer-motion";

const AdminNepalGameCount = () => {
    const dispatch = useDispatch();
    const { gameCounts, loading } = useSelector((state) => state.nepalGameCount);
...
export default AdminNepalGameCount;