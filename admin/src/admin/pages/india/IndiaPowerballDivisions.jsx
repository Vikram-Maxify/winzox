...
} from "../../redux/india/IndiaPowerballDivisionSlice";
...
const IndiaPowerballDivisions = () => {
  ...
  const {
    ...
    (state) => state.indiaPowerballDivision || {}
  );
...
export default IndiaPowerballDivisions;
