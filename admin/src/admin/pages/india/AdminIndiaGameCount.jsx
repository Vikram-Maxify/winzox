...
import {
    ...
    createGameCount,
    updateGameCount,
} from "../../redux/india/gameCountSlice";
import { getTicketTypes } from "../../redux/ticketTypeSlice";
import { motion, AnimatePresence } from "framer-motion";

const AdminIndiaGameCount = () => {
    const dispatch = useDispatch();
    const { gameCounts, loading } = useSelector((state) => state.indiaGameCount);
...
export default AdminIndiaGameCount;