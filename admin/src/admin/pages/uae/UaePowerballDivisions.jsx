...
} from "../../redux/uae/UaePowerballDivisionSlice";
...
const UaePowerballDivisions = () => {
  ...
  const {
    ...
    (state) => state.uaePowerballDivision || {}
  );
...
export default UaePowerballDivisions;
