...
} from "../../redux/australia/AustraliaPowerballDivisionSlice";
...
const AustraliaPowerballDivisions = () => {
  ...
  const {
    ...
    (state) => state.australiaPowerballDivision || {}
  );
...
export default AustraliaPowerballDivisions;
