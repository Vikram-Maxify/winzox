...
import {
    ...
    createGameCount,
    updateGameCount,
} from "../../redux/australia/gameCountSlice";
import { getTicketTypes } from "../../redux/ticketTypeSlice";
import { motion, AnimatePresence } from "framer-motion";

const AdminAustraliaGameCount = () => {
    const dispatch = useDispatch();
    const { gameCounts, loading } = useSelector((state) => state.australiaGameCount);
...
export default AdminAustraliaGameCount;