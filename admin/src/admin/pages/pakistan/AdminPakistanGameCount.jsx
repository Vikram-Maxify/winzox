...
import {
    ...
    createGameCount,
    updateGameCount,
} from "../../redux/pakistan/gameCountSlice";
import { getTicketTypes } from "../../redux/ticketTypeSlice";
import { motion, AnimatePresence } from "framer-motion";

const AdminPakistanGameCount = () => {
    const dispatch = useDispatch();
    const { gameCounts, loading } = useSelector((state) => state.pakistanGameCount);
...
export default AdminPakistanGameCount;