...
} from "../../redux/canada/CanadaPowerballDivisionSlice";
...
const CanadaPowerballDivisions = () => {
  ...
  const {
    ...
    (state) => state.canadaPowerballDivision || {}
  );
...
export default CanadaPowerballDivisions;
