...
import {
    ...
    createGameCount,
    updateGameCount,
} from "../../redux/canada/gameCountSlice";
import { getTicketTypes } from "../../redux/ticketTypeSlice";
import { motion, AnimatePresence } from "framer-motion";

const AdminCanadaGameCount = () => {
    const dispatch = useDispatch();
    const { gameCounts, loading } = useSelector((state) => state.canadaGameCount);
...
export default AdminCanadaGameCount;