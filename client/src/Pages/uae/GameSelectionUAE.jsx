...
// GameSelectionUAE.jsx - Country-specific Redux
...
import { getGameCounts } from "../redux/slices/uae/gameCountSlice";
import {
  createGameEntry,
  resetGameEntryState,
...
const GameSelection = () => {
  ...
  } = useSelector((state) => state.uaeGameEntry);
  ...
  const activeCountryName = urlCountry || "UAE";
