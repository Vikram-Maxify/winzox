...
// GameSelectionNepal.jsx - Country-specific Redux
...
import { getGameCounts } from "../redux/slices/nepal/gameCountSlice";
import {
  createGameEntry,
  resetGameEntryState,
...
const GameSelection = () => {
  ...
  } = useSelector((state) => state.nepalGameEntry);
  ...
  const activeCountryName = urlCountry || "Nepal";
