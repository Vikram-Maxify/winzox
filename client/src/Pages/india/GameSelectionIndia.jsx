...
// GameSelectionIndia.jsx - Country-specific Redux
...
import { getGameCounts } from "../redux/slices/india/gameCountSlice";
import {
  createGameEntry,
  resetGameEntryState,
...
const GameSelection = () => {
  ...
  } = useSelector((state) => state.indiaGameEntry);
  ...
  const activeCountryName = urlCountry || "India";
