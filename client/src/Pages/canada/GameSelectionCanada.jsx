...
// GameSelectionCanada.jsx - Country-specific Redux
...
import { getGameCounts } from "../redux/slices/canada/gameCountSlice";
import {
  createGameEntry,
  resetGameEntryState,
...
const GameSelection = () => {
  ...
  } = useSelector((state) => state.canadaGameEntry);
  ...
  const activeCountryName = urlCountry || "Canada";
