...
// GameSelectionPakistan.jsx - Country-specific Redux
...
import { getGameCounts } from "../redux/slices/pakistan/gameCountSlice";
import {
  createGameEntry,
  resetGameEntryState,
...
const GameSelection = () => {
  ...
  } = useSelector((state) => state.pakistanGameEntry);
  ...
  const activeCountryName = urlCountry || "Pakistan";
  ...
  // Get country code - this will be sent to dispatch
  const activeCountryCode = useMemo(() => {
    return getCountryCodeFromName(activeCountryName);
  }, [activeCountryName]);

  // Get full country object for display
