...
export const createGameEntry = createAsyncThunk(
  ...
  async (formData, { rejectWithValue }) => {
    try {
      const { data } = await api.post("/canada/game-entry", formData);
      return data;
    } catch (error) {
...
export const getMyGameEntries = createAsyncThunk(
  ...
  async (params = {}, { rejectWithValue }) => {
    try {
      ...
      const url = queryString ? `/canada/game-entry?${queryString}` : "/canada/game-entry";
...
export const getSingleGameEntry = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const { data } = await api.get(`/canada/game-entry/${id}`);
      return data.data;
    } catch (error) {
      return rejectWithValue(
        error.response?.data?.message || "Something went wrong."
...
export const getEntryResults = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const { data } = await api.get(`/canada/game-entry/${id}/results`);
      return data.data;
    } catch (error) {
      return rejectWithValue(
        error.response?.data?.message || "Something went wrong."
...
export const deleteGameEntry = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      await api.delete(`/canada/game-entry/${id}`);
      return id;
    } catch (error) {
      return rejectWithValue(
        error.response?.data?.message || "Something went wrong."
...
export const cancelGameEntry = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      const { data } = await api.put(`/canada/game-entry/${id}/cancel`);
      return data;
    } catch (error) {
      return rejectWithValue(
        error.response?.data?.message || "Something went wrong."
...
export const getEntriesByCountry = createAsyncThunk(
  ...
  async (country, { rejectWithValue }) => {
    try {
      const { data } = await api.get(`/canada/game-entry/country/${country}`);
      return data.data;
    } catch (error) {
      return rejectWithValue(
        error.response?.data?.message || "Something went wrong."
